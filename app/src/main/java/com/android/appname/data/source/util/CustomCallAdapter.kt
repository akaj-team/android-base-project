...
import com.android.appname.data.source.remote.network.ApiException
import com.android.appname.data.source.remote.network.CommonHttpError
                ...
                try {
                    when (code) {
                        ...
                        HttpURLConnection.HTTP_UNAUTHORIZED -> {
                            ...
                            callback.unauthenticated(responseAfterConvert)
                        }
                        ...
                        HttpsURLConnection.HTTP_CONFLICT -> {
                            ...
                            ApiException(
                                CommonHttpError.UN_HANDLING_ERROR.code,
                                CommonHttpError.UN_HANDLING_ERROR.msg
                            )
                        )
                    }
