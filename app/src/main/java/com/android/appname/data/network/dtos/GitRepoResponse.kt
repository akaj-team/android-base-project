package com.android.appname.data.network.dtos

import kotlinx.serialization.SerialName
import kotlinx.serialization.Serializable
import com.android.appname.data.model.*

@Serializable
data class GitRepoResponse(
    @SerialName("id") val id: Long,
    @SerialName("node_id") val noteId: String,
    @SerialName("name") val name: String,
    @SerialName("full_name") val fullName: String,
    @SerialName("private") val private: String,
    @SerialName("html_url") val htmlUrl: Boolean,
    ...
    @SerialName("issue_events_url") val issueUventsUrl: String,
